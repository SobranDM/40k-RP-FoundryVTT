export const migrateWorld = async () => {
  ...
  const worldSchemaVersion = Number(game.settings.get("whfortyrp", "worldSchemaVersion"));
  if (worldSchemaVersion !== schemaVersion && game.user.isGM) {
    ...
    game.settings.set("whfortyrp", "worldSchemaVersion", schemaVersion);
                    ...
                    // Be extra careful and filter out bad data because the existing data is bugged
                      ...
                      ?.map(textAptitude => {
                        return {
                          ...
                          type: "aptitude",
                          isAptitude: true,
                          img: "systems/whfortyrp/asset/icons/aptitudes/aptitude400.png"
                        };
                      });
